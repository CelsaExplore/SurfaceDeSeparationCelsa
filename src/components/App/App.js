...
import BoardWeb from '../Board_web/Board_web';
            ...
            if(isMobile()) {
                return (
                    <div className="App">
                        ...
                        <Swipeable className="App__swipeable" onSwipedLeft={swipeLeft} onSwipedRight={swipeRight}
                                   onClick={clickBoard}>
                ...
                config.ratio.width = 1920/2;
                config.ratio.height = 1080;
                return (
                    <div className="App">
                        <SplashScreen/>
                        <Header/>
                        ...
                        <Swipeable className="App__swipeable" onSwipedLeft={swipeLeft} onSwipedRight={swipeRight}
                                   onClick={clickBoard}>
                            <BoardWeb datas={this.state.datas}/>
                        </Swipeable>
                        <Progressbar/>
                        <ShareLayer/>
                        <Tutorial/>
